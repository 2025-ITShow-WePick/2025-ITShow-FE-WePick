  ...
  return (
    <div className={styles.placeholderWrapper}>
      ...
      >
        ...
        {stackedImages.map((img, n) => (
          <div
            ...
            style={{
              ...
              zIndex: n + 1,
              transition:
                "transform 0.7s cubic-bezier(0.4,0,0.2,1), opacity 0.4s",
              position: "absolute",
        ...
        {/* 클릭 안내 아이콘/텍스트 */}
        <div
          className={`${styles.placeholderClick} ${clicked ? styles.hide : ""}`}
        >
